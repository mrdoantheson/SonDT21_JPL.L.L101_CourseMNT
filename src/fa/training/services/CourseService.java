...
import fa.training.utils.CourseTitleCompare;
...
public class CourseService {
    ...
    public void sortAndDisplay(List<Course> courses) {
        ...
        for (Course course : courses) {
            System.out.format("%s%20s%12.3f%5d%100s%n", course.getId(), course.getTitle(), course.getCredit(), course.getEnrollment(), course.getStudents());
        }
    }
